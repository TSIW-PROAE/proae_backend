...
export class Migration1745720960452 implements MigrationInterface {
    name = 'Migration1745720960452'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inscricao" ("inscricao_id" SERIAL NOT NULL, "data_inscricao" date NOT NULL, "status_inscricao" "public"."inscricao_status_inscricao_enum" NOT NULL, "alunoAlunoId" integer, "editalId" integer, CONSTRAINT "PK_989c86adc44071ebe6372a44d81" PRIMARY KEY ("inscricao_id"))`);
