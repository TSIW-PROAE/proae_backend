...
export class Migration1748219560347 implements MigrationInterface {
    name = 'Migration1748219560347'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "validacao" ("id" SERIAL NOT NULL, "status" "public"."validacao_status_enum" NOT NULL, "parecer" character(255), "data_validacao" date, CONSTRAINT "PK_251178d66bc4f11f6d945c044d4" PRIMARY KEY ("id"))`);
